...
export class MarketplaceComponent implements OnInit {
  ...
  albums: Album[] = [
   ...
   new Album('Twilight of the Thunder God', 'Amon Amarth',
       'Seventh album by the Swedish band, released in 2008, based on Thors battle with the serpent Jörmungandr.', 3),
   ...
   new Album('Chopin - Complete Nocturnes', 'Brigitte Engerer',
       'Released in 2010, this is Engeres own rendition of the classical composer Chopin.', 5),
